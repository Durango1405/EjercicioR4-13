...
if color_bolita == "blanca":
   ...
   valor_final = valor_compra - (valor_compra * descuento_azul)
    ...
    valor_final = None # "none" porque no hubo un color válido para la bolita

# Mostrar el valor final a pagar
if valor_final is not None:
    print(f"Valor total a pagar: {valor_final}") # si el color de la bolita fue válido, se hará su respectivo descuento
